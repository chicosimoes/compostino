...
int ledMetanook =12; //ausencia metano
...
int ledcalormeso = 6;   //ascende pino na temperatura boa para bact mesofilicas
int ledcalortermo = 7;  //ascende pino na temperatura boa para bact termofilicas
int ledcalorfrito = 8;  //ascende pino quando temperatura  muito alta
...
int ledseco= 2;
int ledok = 3;  //ascende pino quando umidade esta baixa. Precisa molhar composteira.
int ledmolhado = 5;  //ascende pino quando umidade esta muito alta. 
...
valorumidade=map(valorumidadem, 0, 1023, 0, 100);
valorMetano=map(valorMetanom, 0, 1023, 0, 100);
